...
class AdminRoute
{
    public function map(Registrar $router)
    {
        $router->group([
            ...
            // Plugin
            $router->get ('/plugin/fetch', 'Admin\\PluginController@index');
            $router->get ('/plugin/types', 'Admin\\PluginController@types');
            $router->post('/plugin/install', 'Admin\\PluginController@install');
            $router->post('/plugin/uninstall', 'Admin\\PluginController@uninstall');
            $router->post('/plugin/upgrade', 'Admin\\PluginController@upgrade');
            $router->post('/plugin/enable', 'Admin\\PluginController@enable');
            $router->post('/plugin/disable', 'Admin\\PluginController@disable');
            $router->post('/plugin/getConfig', 'Admin\\PluginController@getConfig');
            $router->post('/plugin/updateConfig', 'Admin\\PluginController@updateConfig');
            $router->post('/plugin/upload', 'Admin\\PluginController@upload');
            $router->post('/plugin/delete', 'Admin\\PluginController@delete');
        });
    }
}
